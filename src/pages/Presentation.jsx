  ...
  return (
    <div>
      ...
      <StepList v={v} accentColor={v.amber} items={[
        ...
        { title: '창고·랙·칸·단 선택', desc: '창고 선택 후 매트릭스에서 칸을 클릭. 자동으로 빈 단이 매칭됩니다. 이미 같은 상품이 있는 단은 강조 표시.' },
  ...
  return (
    <div>
      ...
      <StepList v={v} accentColor={v.red} items={[
        ...
        { title: '출고 위치 자동 선택', desc: 'F1 위치(랙·칸·단)가 자동으로 화면에 표시됩니다. 수량 확인 후 "출고 실행" 버튼으로 확정.' },
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 22 }}>
        <FeatureCard v={v} label="입고 처리"
          desc="웹에서 등록한 입고예정을 선택. 창고·랙·칸·단을 터치로 선택. 전동랙은 열기/멈춤으로 제어."
          color={v.amber} colorDim={v.amberDim}
      ...
      <StepList v={v} accentColor={v.amber} items={[
        ...
        { title: '입고: 위치 선택 후 처리', desc: '창고→랙→칸→단 순서로 터치 선택. 빈 단 자동 매칭. 수량 입력 후 실행.' },
