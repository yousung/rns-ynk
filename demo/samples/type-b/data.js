...
const racks = [
  ...
  // 창고3 전동랙 (30개 — rack_no 1~15: 4단×10칸, rack_no 16~30: 3단×10칸)
...
const pallets = [
  ...
  { id: 12, location: '25-2-1' },
  { id: 13, location: '30-3-3' },
  { id: 14, location: '35-2-2' },
  { id: 15, location: '11-2-5' }, // 창고3 2번 랙 2단 5칸 - 10종 혼합 팔레트
];
...
const products = [
  ...
  { id: 4,  code: 'P004', name: '상품D', created_at: '2026-02-05' },
  { id: 5,  code: 'P005', name: '상품E', created_at: '2026-02-10' },
  { id: 6,  code: 'P006', name: '상품F', created_at: '2026-02-15' },
  { id: 7,  code: 'P007', name: '상품G', created_at: '2026-02-20' },
  { id: 8,  code: 'P008', name: '상품H', created_at: '2026-03-01' },
  { id: 9,  code: 'P009', name: '상품I', created_at: '2026-03-05' },
  { id: 10, code: 'P010', name: '상품J', created_at: '2026-03-10' },
];
...
const inventoryItems = [
  ...
  // 창고3 2번 랙 2단 5칸 — 10종 혼합 샘플 팔레트
  { id: 10, product_id: 1,  pallet_id: 15, quantity: 6,  received_at: '2026-04-05' },
  { id: 11, product_id: 2,  pallet_id: 15, quantity: 8,  received_at: '2026-04-05' },
  { id: 12, product_id: 3,  pallet_id: 15, quantity: 5,  received_at: '2026-04-06' },
  { id: 13, product_id: 4,  pallet_id: 15, quantity: 12, received_at: '2026-04-06' },
  { id: 14, product_id: 5,  pallet_id: 15, quantity: 7,  received_at: '2026-04-07' },
  { id: 15, product_id: 6,  pallet_id: 15, quantity: 10, received_at: '2026-04-07' },
  { id: 16, product_id: 7,  pallet_id: 15, quantity: 4,  received_at: '2026-04-08' },
  { id: 17, product_id: 8,  pallet_id: 15, quantity: 9,  received_at: '2026-04-08' },
  { id: 18, product_id: 9,  pallet_id: 15, quantity: 11, received_at: '2026-04-09' },
  { id: 19, product_id: 10, pallet_id: 15, quantity: 3,  received_at: '2026-04-09' },
];
